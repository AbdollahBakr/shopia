...
class ComposotionalLayout {
    ...
    let sectionHeaderElementKind = "header"
    ...
    func createSecoendSection() -> NSCollectionLayoutSection {
        ...
        let header = NSCollectionLayoutBoundarySupplementaryItem(layoutSize: headerSize, elementKind: sectionHeaderElementKind, alignment: .top)
    ...
    func createCustom() -> NSCollectionLayoutSection  {
        ...
        let header = NSCollectionLayoutBoundarySupplementaryItem(layoutSize: headerSize, elementKind: sectionHeaderElementKind, alignment: .topLeading)
    ...
    func createFirstSection() -> NSCollectionLayoutSection {
        ...
        let headerLeading = NSCollectionLayoutBoundarySupplementaryItem(layoutSize: headerSize, elementKind: sectionHeaderElementKind, alignment: .topLeading)
