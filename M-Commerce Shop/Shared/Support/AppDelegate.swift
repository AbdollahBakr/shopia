...
class AppDelegate: UIResponder, UIApplicationDelegate {
        ...
        conncetion.reachability.whenUnreachable = { reachability in
            ...
            DispatchQueue.main.async {
                    ...
                    if let window = self.window, let rootViewController = window.rootViewController {
                        ...
                        currentController.modalTransitionStyle   = .crossDissolve
                        currentController.present(self.controller, animated: true, completion: nil)
                    }
                
            }
        }
        
        // Status Bar TintColor
        UINavigationBar.appearance().barTintColor = UIColor.systemBackground
        
        
        // Status Bar TitleColor
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "M_Commerce_Shop")
